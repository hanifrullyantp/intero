...
CREATE TABLE IF NOT EXISTS public.leads (
  ...
  crm_status text DEFAULT 'baru',
  crm_category text DEFAULT '',
  admin_notes text DEFAULT '',
  last_follow_up_key text,
