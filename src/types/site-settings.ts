...
function patchLegacyLandingData(sec: LandingSections): LandingSections {
  ...
  if (
    hero.primaryCtaHref === undefined ||
    hero.primaryCtaHref === "#harga" ||
    hero.primaryCtaHref === "#bonus" ||
    hero.primaryCtaHref === "https://www.intero.id/#harga"
  ) {
    hero.primaryCtaHref = "https://www.intero.id/#bonus";
  }
  ...
  return {
    ...
    sections: {
      hero: {
        ...
        primaryCtaHref: "https://www.intero.id/#bonus",
